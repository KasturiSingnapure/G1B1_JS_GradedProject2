document.addEventListener("DOMContentLoaded", () => {
  ...
  function displayApplicant(applicant) {
    ...
    document.getElementById("ss-institute").textContent =
      applicant.education["Senior Secondary"].institute;
    document.getElementById("ss-cgpa").textContent =
      applicant.education["Senior Secondary"].cgpa;

    document.getElementById("school-institute").textContent =
      applicant.education["High School"].institute;
    document.getElementById("school-cgpa").textContent =
  ...
  function displayApplicantByJob(job) {
    filteredData = applicants.filter((item) =>
      item.basics.AppliedFor.toLowerCase().includes(job.toLowerCase())
    );
    counter = 0;
